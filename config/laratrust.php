...
return [
    ...
    */
    'foreign_keys' => [
        /**
         * admin foreign key on Laratrust's role_admin and admin_permission tables.
         */
        'admin' => 'admin_id',
        ...
        /**
         * Role foreign key on Laratrust's admin_permission and permission_role tables.
         */
        'permission' => 'permission_id',

        /**
         * Role foreign key on Laratrust's role_admin and admin_permission tables.
         */
        'team' => 'team_id',
    ...
    */
    'middleware' => [
        ...
        'handlers' => [
            ...
            /**
             * Redirects the admin to the given url.
