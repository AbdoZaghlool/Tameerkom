...
<body class=" login">
    <div class="logo">
        <a href="#">
            {{--  <img src="{{ URL::asset('images/'.\App\Setting::first()->logo) }}" height="100px;" style="background-color: aliceblue;"  --}}
            @php
                $image = \App\Setting::first()->logo ?? 'default.png';
            @endphp
            <img src="{{ asset('images/'.$image) }}" height="100px;" style="background-color: aliceblue;"
                alt="" />
        </a>
    </div>
    <div class="content">
    ...
    <div class="copyright"> {{ date('Y') }} © تطوير بواسطة
        <a href="tqnee.com.sa" target="_blank"> شركة تقني. </a>
    </div>
