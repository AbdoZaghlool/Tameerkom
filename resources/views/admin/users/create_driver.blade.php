            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light ">
                        ...
                        <form role="form" action="{{route('users.store',['type'=>2])}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        ...
                                        <div class="form-group {{$errors->has('driver_license')?'has-error':''}}">
                                            ...
                                            <input type="text" name="driver_license" placeholder="رقم الاستمارة"
                                                class="form-control" value="{{old('driver_license')}}" />
                                        ...
                                        <div class="form-group {{$errors->has('type_id')?'has-error':''}}">
                                            ...
                                            null, ['class' => 'form-control','placeholder'=> 'اختر نوع']) !!}
                                            @error('type_id')
