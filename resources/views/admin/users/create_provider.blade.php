                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light ">
                            ...
                            <form role="form" action="{{ route('users.store', ['type' => 1]) }}" method="post"
                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            ...
                                            {{-- <!-- commercial_record --> --}}
                                            <div
                                                class="form-group {{ $errors->has('commercial_record') ? 'has-error' : '' }}">
                                                <label class="control-label">السجل التجاري</label>
                                                <input type="text" name="commercial_record" placeholder="السجل التجاري"
                                                    class="form-control" value="{{ old('commercial_record') }}" />
                                                @error('commercial_record')
                                                    <span
                                                        class="status-error">{{ $errors->first('commercial_record') }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group {{ $errors->has('region_id') ? 'has-error' : '' }}">
                                                ...
                                                {!! Form::select('region_id', App\Region::pluck('name', 'id'), null, ['class' => 'form-control', 'placeholder' => 'اختر منطقة']) !!}
                                                @error('region_id')
                                            ...
                                            <div
                                                ...
                                                @error('password_confirmation')
                                                    <span
                                                        class="status-error">{{ $errors->first('password_confirmation') }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-body col-md-6">
                                                    <div
                                                        class="form-group {{ $errors->has('commercial_image') ? 'has-error' : '' }} ">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            @error('commercial_image')
                                                                <span
                                                                    class="status-error">{{ $errors->first('commercial_image') }}</span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-body col-md-6">
                                                    <div
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            @error('image')
                                                                <span
                                                                    class="status-error">{{ $errors->first('image') }}</span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex">
                                                    <div class="col-m-9">
                                                        <div class="content sections">
                                                            <div
                                                                class="form-group {{ $errors->has('latitude') ? 'has-error' : ($errors->has('longitude') ? 'has-error' : '') }}">
                                                                ...
                                                                @error('latitude')
                                                                    <span
                                                                        class="status-error">{{ $errors->first('latitude') }}</span>
                                                                @enderror
                                                                ...
                                                                @error('longitude')
                                                                    <span
                                                                        class="status-error">{{ $errors->first('longitude') }}</span>
                                                                @enderror
                                                            </div>
                                                            <div id="map"></div>
                                                        </div>
