...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>تعديل اسرة</span>
        </li>
    </ul>
</div>

<h1 class="page-title"> الاسر المنتجة
    <small>تعديل اسرة</small>
</h1>
@endsection
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        ...
                                        <div class="form-group {{$errors->has('tax_number')?'has-error':''}}">
                                            ...
                                            <input type="text" name="tax_number" placeholder="الرقم الضريبي"
                                                class="form-control" value="{{$user->tax_number}}" />
                                            @error('tax_number')
                                        ...
                                        <div class="form-group {{$errors->has('topic_id')?'has-error':''}}">
                                            ...
                                            {!! Form::select('topic_id[]', App\Topic::pluck('name','id'),$user->topics, 
                                        ...
                                        <div class="form-group {{$errors->has('work_start_at')?'has-error':''}}">
                                            ...
                                            <input type="time" name="work_start_at" class="form-control" value="{{$user->work_start_at}}" />
                                            @error('work_start_at')
                                        ...
                                        <div class="form-group {{$errors->has('work_end_at')?'has-error':''}}">
                                            ...
                                            <input type="time" name="work_end_at" class="form-control" value="{{$user->work_end_at}}" />
                                            @error('work_end_at')
