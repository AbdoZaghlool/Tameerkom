            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="btn-group">
                                <a class="btn sbold green" href="{{route('users.create',['type'=> 2])}}"> إضافة جديد
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                @foreach ($user->periods as $shift)
                                {{$shift->time_count }} (ساعة)<br>
                                @endforeach
                                @endif
                            </td>
                            <td>{{$user->periods()->sum('time_count')}}</td>
                            <td>
                                <div class="btn-group">
